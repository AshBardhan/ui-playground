        ...
        return (
          <div key={index}>
            {isReadOnly ? (
              <div>
                {index > 0 && (
                  <span className="mr-2">{cond.logicalOperator}</span>
                )}
              ...
              <>
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <DropdownList
                    ...
                    onSelect={(val) =>
                      onFieldChange && onFieldChange(index, val)
                    }
                  />
                  ...
                  {fieldSchema && (
                    <DropdownList
                      ...
                      onSelect={(val) =>
                        onOperatorChange && onOperatorChange(index, val)
                      }
                    />
                  )}
                  ...
                  {fieldSchema?.type === "enum" && fieldSchema.values ? (
                    <DropdownList
                      ...
                      onSelect={(val) =>
                        onValueChange && onValueChange(index, val)
                      }
                    />
                  ) : (
                    <Input
